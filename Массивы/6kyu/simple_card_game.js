...
function winner(deckSteve, deckJosh) {
    ...
    for (let i = 0; i < deckSteve.length; i++) {
        if (cardOrder[deckSteve[i]] > cardOrder[deckJosh[i]]) {
            pointsSteve++;
        } else if (cardOrder[deckSteve[i]] < cardOrder[deckJosh[i]]) {
            pointsJosh++;
        }
    }
    ...
    } else if (pointsSteve < pointsJosh) {
